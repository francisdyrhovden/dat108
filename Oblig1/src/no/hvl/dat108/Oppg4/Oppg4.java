...
public class Oppg4 {
	...
	public static void main(String[] args) {
		...
		List<Ansatt> ansatte = Arrays.asList(
				...
				new Ansatt("Bjørnar", "Espeland", Kjonn.MANN, "Vaktmester", 20000),
		...
		System.out.println("c) Gjennomsnittslønn for kvinner: " + gjsnittKvinner);
		...
		System.out.println("d) Sjefer: " + sjefer);
		
		
		
		//e) Finne ut om det er noen ansatte som tjener over 800 000
		boolean tjenerMer = ansatte.stream().anyMatch(a -> a.getAarslonn() > 800000);
		System.out.println("e) Finnes det en ansatt som tjener mer enn 800000?: " + tjenerMer);
